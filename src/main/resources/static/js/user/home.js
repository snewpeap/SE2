...
$(document).ready(function () {
    ...
    firstImageStr = "<img src=\""+ newestList[0].image + "\" alt=\"\" class=\"img-responsive\" />";
    ...
    firstImageStr = "<img src=\""+ highestList[0].image + "\" alt=\"\" class=\"img-responsive\" />";
    ...
    firstImageStr = "<img src=\""+ mostList[0].image + "\" alt=\"\" class=\"img-responsive\" />";
    ...
    function joinedPromotion(List,n,str) {
        if (List[n].getJoinedPromotions()!==null && List[n].getJoinedPromotions().length!==0){
    ...
    function getFirstInfoStr(List) {
        ...
        firstMovieInfo += "<p class=\"fexi_header\">"+ List[0].name+"</p>" +
            ...
            "<p class=\"fexi_header_para\"><span>上映日期<label>:</label></span>"+ List[0].start+"</p>" +
            "<p class=\"fexi_header_para\"><span>类型<label>:</label></span>"+ List[0].type+"</p>" +
            "<p class=\"fexi_header_para\"><span>想看人数<label>:</label></span>"+ List[0].getLikeNum()+"</p>" +
    ...
    function getTopMovieImage() {
        var res = '';
        res += "<img src=\"" + mostList[0].image + "\" alt=\"\" class=\"img-responsive\" />";
        return res;
    }
    ...
    function getTopMovieInfo() {
        ...
        res += "<p class=\"fexi_header\"> </p>" +
            ...
            "<p class=\"fexi_header_para\"><span>上映日期<label>:</label></span>" + mostList[0].startDate + "</p>" +
            "<p class=\"fexi_header_para\"><span>类型<label>:</label> </span>" + mostList[0].type +
            "<p class=\"fexi_header_para fexi_header_para1\"><span>想看人数<label>:</label></span>" + mostList[0].getLikeNum() + "</p>";
        return res;
    }
});